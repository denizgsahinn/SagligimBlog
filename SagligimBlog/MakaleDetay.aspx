<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MakaleDetay.aspx.cs" Inherits="SagligimBlog.MakaleDetay" %>
    ...
    <div class="arthicle">
     ...
     <div style="min-height: 500px;">
        <div class="yorum" style="margin-top:50px;">
            ...
            <asp:Panel ID="pnl_girisyok" runat="server" style="margin:30px 0;">
